...
class Testunijson(unittest.TestCase):

    def test_encoder(self):
        # Test already supported types:
        d = {"peuh":12}
        expected = '{"peuh": 12}'
        self.assertEqual(unijson.dumps(d), expected)
        self.assertEqual(unijson.dumps(d), json.dumps(d))

        l = [False, True, None, ("Well", "I test thoroughly")]
        expected = '[false, true, null, ["Well", "I test thoroughly"]]'
        self.assertEqual(unijson.dumps(l), expected)
        self.assertEqual(unijson.dumps(l), json.dumps(l))

        # Test custom classes:
        o = NothingDefined(12, 55789)
        s = unijson.dumps(o)
        d = json.loads(s)
        expected = {"__module__": "test_unijson", "__class__": "NothingDefined", "a1": 12, "a2": 55789}
        self.assertDictEqual(d, expected)

        o = DefineEncoder(1643, NothingDefined("sgfd", [12, False, True, "peuh"]))
        s = unijson.dumps(o)
        d = json.loads(s)
        expected = {"__module__": "test_unijson", "__class__": "DefineEncoder", "a1": 1643,
                    "a2": {"__module__": "test_unijson", "__class__": "NothingDefined", "a1": "sgfd",
        ...
        s = unijson.dumps(o)
        d = json.loads(s)
        expected = {"__module__":"datetime", "__class__":"date", "date":"2018-08-13"}
        self.assertDictEqual(d, expected)

        o = datetime.datetime(2018, 8, 13, 18, 53, 42, tzinfo=pytz.timezone("Europe/Dublin"))
        s = unijson.dumps(o)
        d = json.loads(s)
        expected = {"__module__":"datetime", "__class__":"datetime", "datetime":"2018-08-13 18:53:42.000000",
                    "tzinfo":{"__module__":"pytz", "__class__":"timezone", "zone":"Europe/Dublin"}}
        self.assertDictEqual(d, expected)

        o = datetime.time(18, 53, 42)
        s = unijson.dumps(o)
        d = json.loads(s)
        expected = {"__module__":"datetime", "__class__":"time", "time": "18:53:42.000000", "tzinfo":None}
        self.assertDictEqual(d, expected)
    ...
    def test_decoder(self):
        ...
        # Test custom classes:
        s = '{"__module__": "test_unijson", "__class__": "NothingDefined", "a1": 12, "a2": 55789}'
        o = unijson.loads(s)
        expected = NothingDefined(12, 55789)
        self.assertEqual(o, expected)

        s = '{"__module__":"test_unijson", "__class__":"DefineDecoder", "a1":12, "a2":55789}'
        o = unijson.loads(s)
        ...
        s = '''{"a1": 1643, "a2": {"a1": "sgfd", "a2": [12, false, true, "peuh"], "__class__": "NothingDefined",
                "__module__": "test_unijson"}, "__class__": "DefineDecoder", "__module__": "test_unijson"}'''
        o = unijson.loads(s)
        ...
        s = '{"__module__":"datetime", "__class__":"date", "date":"2018-08-13"}'
        o = unijson.loads(s)
        expected = datetime.date(2018, 8, 13)
        self.assertEqual(o, expected)

        s = '''{"__module__":"datetime", "__class__":"datetime", "datetime":"2018-08-13 18:53:42.000000",
                "tzinfo":{"__module__":"pytz", "__class__":"timezone", "zone":"Europe/Dublin"}}'''
        o = unijson.loads(s)
        expected = datetime.datetime(2018, 8, 13, 18, 53, 42, tzinfo=pytz.timezone("Europe/Dublin"))

        s = '''{"__module__":"datetime", "__class__":"time", "time":"18:53:42.000000", "tzinfo":null}'''
        o = unijson.loads(s)
    ...
    def test_serialiser(self):
        ...
        self.assertEqual(o, unijson.loads(unijson.dumps(o)))
